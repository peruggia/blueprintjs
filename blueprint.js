(function () {
    window.blueprint = function (properties) {
        ...
        if (typeof properties === "object"
            ...
            throw new Error("To make a Class an Object with its properties is required");
        }
        ...
        blueprintCreator.prototype = {
            get: function (propertyName) {
                var value = this.extendedProperties[propertyName] || initialProperties[propertyName];
